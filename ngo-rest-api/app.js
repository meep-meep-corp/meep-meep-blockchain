...
// POST activity
app.post('/activities', awaitHandler(async (req, res) => {
	logger.info('================ POST on Activity');
	var args = req.body;
	var fcn = "registerActivity";

    logger.info('##### POST on Activity - username : ' + username);
	logger.info('##### POST on Activity - userOrg : ' + orgName);
	logger.info('##### POST on Activity - channelName : ' + channelName);
	logger.info('##### POST on Activity - chaincodeName : ' + chaincodeName);
	logger.info('##### POST on Activity - fcn : ' + fcn);
	logger.info('##### POST on Activity - args : ' + JSON.stringify(args));
	logger.info('##### POST on Activity - peers : ' + peers);
...
app.get('/activities', awaitHandler(async (req, res) => {
	logger.info('================ GET on Activity');
	let args = {};
	let fcn = "queryAllDonors";

    logger.info('##### GET on Activity - username : ' + username);
	logger.info('##### GET on Activity - userOrg : ' + orgName);
	logger.info('##### GET on Activity - channelName : ' + channelName);
	logger.info('##### GET on Activity - chaincodeName : ' + chaincodeName);
	logger.info('##### GET on Activity - fcn : ' + fcn);
	logger.info('##### GET on Activity - args : ' + JSON.stringify(args));
	logger.info('##### GET on Activity - peers : ' + peers);
